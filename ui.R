  ...
  tabItems(
    ...
    tabItem( tabName = 'prumysl',
            ...
            fluidRow(column(width = 12, plotlyOutput('pr_multichart'))),
             ...
             h1(paste0("Zaměstnanost a mzdy ", format(max_date_pr, format = "%B %Y") ),
                style = "color: #2426A8") ,
             fluidRow(
    ...
    tabItem( tabName = 'nefinancni_podniky',
             ...
             h2(paste0("Základní ukazatele z individuálních dat o nefiančních podnicích ČSÚ (výkaz P 6-04)")),
             
             ## 3.1.1 Zvolte ukazatel 
             
             fluidRow(column(width = 3, selectizeInput(inputId = "np_select_var",
                                                       "Zvolte ukazatel", 
                                                       choices =  unique(p604_sa$var), 
                                                       selected = unique(p604_sa$var)[1],
                                                       multiple = F)),
                      column(width = 6, selectizeInput(inputId = "np_select_odv",
                                                       "Zvolte odvětví", 
             ...
             fluidRow(column(width = 12,sliderInput("np_date_slider",
                                                    ...
                                                    step = 95, width = 1000,
                                                    value=c(as.Date("2018-01-01"),max(p604_sa$date)),
                                                    timeFormat="%m/%y"))),
